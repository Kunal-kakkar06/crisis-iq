...
export default function DemoMode({ onClose }) {
  const biasScore = useCountUpDemo(0.71, 0.23, 3000, 2);
  const responseTime = useCountUpDemo(4320, 4.2, 3000, 1);
  const wayanadRes = useCountUpDemo(0, 8, 3000, 0);
  const aidWasted = useCountUpDemo(38, 7.3, 3000, 1);
    ...
    <div className="demo-overlay animate-fade-in">
      <header className="demo-header">
        <div className="demo-header-content">
          <h2>CrisisIQ Comparison — Kerala Floods 2018</h2>
      ...
      <div className="demo-split">
        ...
        <div className="demo-pane demo-left">
          <div className="pane-title">
            ...
            <p>Kerala Floods 2018 — Actual Response</p>
          </div>
          ...
          <div className="demo-map-wrapper">
             <div className="fake-map" style={{ backgroundImage: `url(${keralaMapImg})` }}>
                ...
                {/* Idukki - Critical One */}
                <MapPoint x={58} y={75} label="Idukki" labelColor="red" resCount={1} size={32} />
          ...
          <div className="demo-stats">
            <div className="demo-stat-row"><span className="stat-label">⏱ Response:</span> <span className="stat-value c-red">72 hours</span></div>
            <div className="demo-stat-row"><span className="stat-label">⚖ Bias Score:</span> <span className="stat-value c-red">0.71</span></div>
            <div className="demo-stat-row"><span className="stat-label">💸 Aid Wasted:</span> <span className="stat-value c-red">38%</span></div>
            <div className="demo-stat-row"><span className="stat-label">💔 Wayanad Help:</span> <span className="stat-value c-red">0 resources</span></div>
            <div className="demo-stat-row"><span className="stat-label">😢 Unreached:</span> <span className="stat-value c-red">40,000+ people</span></div>
          </div>

          <div className="pane-banner banner-red">
            "483 lives lost — resources were available but misallocated"
          </div>
        </div>
        ...
        <div className="demo-pane demo-right">
          <div className="pane-title">
            <h3>WITH CrisisIQ</h3>
            <p>AI-Optimised Fair Allocation</p>
          </div>
          ...
          <div className="demo-map-wrapper">
             <div className="fake-map" style={{ backgroundImage: `url(${keralaMapImg})` }}>
                ...
                {/* Ernakulam - Balanced */}
                <MapPoint x={50} y={65} label="Ernakulam (balanced)" labelColor="green" resCount={5} size={32} />
             </div>
          </div>

          <div className="demo-stats">
            <div className="demo-stat-row"><span className="stat-label">⏱ Response:</span> <span className="stat-value c-green">{responseTime} min</span></div>
            <div className="demo-stat-row"><span className="stat-label">⚖ Bias:</span> <span className="stat-value c-green">{biasScore}</span></div>
            <div className="demo-stat-row"><span className="stat-label">💸 Aid Wasted:</span> <span className="stat-value c-green">{aidWasted}%</span></div>
            <div className="demo-stat-row"><span className="stat-label">💚 Wayanad Help:</span> <span className="stat-value c-green">{wayanadRes} resources</span></div>
            <div className="demo-stat-row"><span className="stat-label">✅ Additional reached:</span> <span className="stat-value c-green">40,000+</span></div>
          </div>
      ...
      <footer className="demo-footer">
        <p>
          483 lives were lost in Kerala 2018. 
